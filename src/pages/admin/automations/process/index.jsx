...
import { automationprocessdata, automationprocessrowdata } from "../../../../utils/constants/tabledata";
...
const Process = () => {
  ...
  return (
    <>
        ...
        <DataTable columnData={automationprocessdata} rowData={automationprocessrowdata} setAnchorEl={setAnchorEl} openEditAction={toggleEditAction} />
